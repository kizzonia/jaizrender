...
class AboutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create about" do
    assert_difference('About.count') do
      post abouts_url, params: { about: { abtimg: @about.abtimg, body: @about.body, icon: @about.icon, slug: @about.slug, sub_title: @about.sub_title, title: @about.title } }
    end
  ...
  test "should update about" do
    patch about_url(@about), params: { about: { abtimg: @about.abtimg, body: @about.body, icon: @about.icon, slug: @about.slug, sub_title: @about.sub_title, title: @about.title } }
